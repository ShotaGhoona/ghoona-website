...
export default function NewsListCard({ thumbnail, tag, date, title, href }: NewsListCardProps) {
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden p-4 flex flex-col gap-4">
      ...
      <div className="mt-auto flex justify-center">
        <Link href={href}>
          <span className="inline-block bg-[#5F7E65] text-white px-6 py-2 rounded-full font-semibold cursor-pointer hover:opacity-80">
            Read more
          </span>
        </Link>
      </div>
