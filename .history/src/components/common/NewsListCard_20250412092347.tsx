  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden p-6 flex flex-col gap-4">
      ...
      <div className="flex justify-between items-center">
        <span className={`px-3 py-1 text-[12px] rounded ${tagColors[tag]} text-gray-800`}>{tag}</span>
      ...
      <div className="mt-auto flex justify-center">
        <Link href={href}>
          <span className="text-[12px] inline-block bg-[#252525] text-white px-4 py-1 rounded-full font-semibold cursor-pointer hover:opacity-80">
            Read more
          </span>
        </Link>
      </div>
