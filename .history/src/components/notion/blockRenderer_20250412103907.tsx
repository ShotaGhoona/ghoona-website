...
export const renderBlock = (block: any): JSX.Element | null => {
  ...
  switch (type) {
    case 'paragraph':
      return value.rich_text && <p><Text text={value.text} /></p>;

    case 'heading_1':
      return value.rich_text && <h1><Text text={value.text} /></h1>;

    case 'heading_2':
      return value.rich_text && <h2><Text text={value.text} /></h2>;

    case 'heading_3':
      return value.rich_text && <h3><Text text={value.text} /></h3>;
