    ...
    <section className="relative w-full px-5 md:px-20 py-10 md:py-20">
            ...
            <>
              ...
              >
                <div className="w-[50%] flex flex-col items-center justify-center">
                  <div className="bg-white/80 shadow-lg rounded-lg w-[70%] h-[80%] flex flex-col items-center justify-center">
      ...
      <AnimatePresence mode="wait">
        {content && (
          ...
          >
            <h1 className="text-[20px] font-bold mb-3">{content.subtitle}</h1>
            <p className="text-[10px] leading-relaxed font-bold" dangerouslySetInnerHTML={{ __html: content.description }}></p>
          </motion.div>
        )}
      </AnimatePresence>
