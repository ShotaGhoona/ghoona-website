          ...
          {content && (
            <>
              ...
              <motion.div
                ...
                className="absolute inset-0 bg-gradient-to-l from-white/90 via-white/60 to-transparent rounded-[10px] hidden md:flex items-center h-full p-10 md:p-20 gap-12 justify-between"
              >
